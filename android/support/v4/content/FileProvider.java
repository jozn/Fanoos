...
public class FileProvider extends ContentProvider {
    ...
    private static de b(Context context, String str) {
        de dfVar = new df(str);
        XmlResourceParser loadXmlMetaData = context.getPackageManager().resolveContentProvider(str, Wbxml.EXT_T_0).loadXmlMetaData(context.getPackageManager(), "android.support.FILE_PROVIDER_PATHS");
