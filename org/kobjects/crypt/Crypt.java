...
public class Crypt {
    ...
    private static int fourBytesToInt(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
        i2 = (byteToUnsigned(bArr[i2]) << 8) | byteToUnsigned(bArr[i]);
        int i4 = i3 + 1;
        i2 |= byteToUnsigned(bArr[i3]) << ITERATIONS;
        i3 = i4 + 1;
        return i2 | (byteToUnsigned(bArr[i4]) << 24);
    }
    ...
    private static int[] des_set_key(byte[] bArr) {
        ...
        i = iArr2[0];
        int i2 = iArr2[1];
        i = (((i & 16711680) >>> ITERATIONS) | (((i & 255) << ITERATIONS) | (65280 & i))) | ((-268435456 & i2) >>> 4);
        i2 &= 268435455;
        int i3 = 0;
        int i4 = 0;
        while (i3 < ITERATIONS) {
            ...
            int i5 = i2 & 268435455;
            int i6 = i & 268435455;
            i = ((skb[0][i5 & 63] | skb[1][((i5 >>> 6) & 3) | ((i5 >>> 7) & 60)]) | skb[2][((i5 >>> 13) & 15) | ((i5 >>> 14) & 48)]) | skb[3][(((i5 >>> 20) & 1) | ((i5 >>> 21) & 6)) | ((i5 >>> 22) & 56)];
            i2 = ((skb[4][i6 & 63] | skb[5][((i6 >>> 7) & 3) | ((i6 >>> 8) & 60)]) | skb[6][(i6 >>> 15) & 63]) | skb[7][((i6 >>> 21) & 15) | ((i6 >>> 22) & 48)];
            int i7 = i4 + 1;
            iArr[i4] = ((i2 << ITERATIONS) | (65535 & i)) & -1;
            i = (i >>> ITERATIONS) | (i2 & -65536);
            i = (i >>> 28) | (i << 4);
            i2 = i7 + 1;
            iArr[i7] = i & -1;
            i3++;
    ...
    private static final int D_ENCRYPT(int i, int i2, int i3, int i4, int i5, int[] iArr) {
        int i6 = (i2 >>> ITERATIONS) ^ i2;
        int i7 = i6 & i4;
        i6 &= i5;
        i7 = ((i7 ^ (i7 << ITERATIONS)) ^ i2) ^ iArr[i3];
        i6 = ((i6 ^ (i6 << ITERATIONS)) ^ i2) ^ iArr[i3 + 1];
        i6 = (i6 << 28) | (i6 >>> 4);
        return (((((SPtrans[7][(i6 >>> 24) & 63] | ((SPtrans[1][i6 & 63] | SPtrans[3][(i6 >>> 8) & 63]) | SPtrans[5][(i6 >>> ITERATIONS) & 63])) | SPtrans[0][i7 & 63]) | SPtrans[2][(i7 >>> 8) & 63]) | SPtrans[4][(i7 >>> ITERATIONS) & 63]) | SPtrans[6][(i7 >>> 24) & 63]) ^ i;
    }
    ...
    private static final int[] body(int[] iArr, int i, int i2) {
        ...
        i5 &= -1;
        int[] iArr2 = new int[2];
        PERM_OP(i5, ((i3 << 31) | (i3 >>> 1)) & -1, 1, 1431655765, iArr2);
        PERM_OP(iArr2[1], iArr2[0], 8, 16711935, iArr2);
        PERM_OP(iArr2[1], iArr2[0], 2, 858993459, iArr2);
        PERM_OP(iArr2[1], iArr2[0], ITERATIONS, 65535, iArr2);
    ...
    public static final String crypt(String str, String str2) {
        ...
        i = 0;
        while (i < bArr.length && i < str2.length()) {
